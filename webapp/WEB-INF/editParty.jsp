...
<body>
	<div class='container-xxl px-md-5 bg-white shadow-lg'>
		...
		<div class='px-4 py-5 my-5 text-center partyTop'>
			<h1 class='display-5 fw-bold'>Edit your Dinner Party!</h1>
			<div class='col-lg-6 mx-auto'>
				<p class='lead'>Make your adjustments below!</p>
			</div>
		

		<div class='row justify-content-center partyForm mt-5'>
			<div class='col-8'>
				<form:form action="/edit/party/${dinnerParty.id }" method="post" modelAttribute="dinnerParty" class="formbox p-3">
