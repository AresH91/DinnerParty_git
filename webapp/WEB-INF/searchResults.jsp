	...
	<div class='container-xxl px-md-5 bg-white shadow-lg'>
		<header
            ...
            <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                    <li class='breadcrumb-item'><a href to='/'>Home</a></li>
                    <li class='breadcrumb-item-active' aria-current="page">&nbsp; /&nbsp; Results</li>
                </ol>
            </nav>
            	<div>
            <div class='row row-cols-2 row-cols-lg-5 g-2 g-lg-3 d-flex flex-wrap mt-4'>

                            <a href={`/recipe/${recipe._id}`} class='col text-center category__a href'>
                                <div class='category__img category__img--large shadow'>
                                    <img src={recipe.image} alt={recipe.name} loading='lazy' />
                                </div>
                                <div class='pt-1'><b>{recipe.name}</b></div>
                            </a>

            </div>
            <div class='px-4 py-5 my-5 text-center'>
                <img class='d-block mx-auto mb-4 img-fluid' loading='lazy' src='https://i.ibb.co/m9pg5KF/Image-3-30-22-at-4-03-PM.jpg'></img>
            </div>
        </div>
            <div><br></br></div>
        </div>
