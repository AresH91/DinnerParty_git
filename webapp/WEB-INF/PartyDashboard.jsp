...
<body>
	<div class='container-xxl px-md-5 bg-white shadow-lg'>
		...
		<div
			class='d-flex align-items-center g-5 py-4 mb-4 justify-content-around'>
			<div
				class='d-flex flex-column justify-content-center formbox dashbox p-3'>
			...
			<div class='col-12 col-lg-4 form-group text-center'>
				...
				<h3>
					Party Code:
					<c:out value="${party.code }" />
				</h3>
				<div class="d-flex flex-row justify-content-center gap-2">
					<form action="/delete/${party.id }/party" method="post">
						<input type="hidden" name="_method" value="delete" />
						<button class="btn btn-danger btn-sm mb-5">Delete Party</button>
					</form>
					<a href="/edit/party/${party.id }"><button
		...
		<div class='pb-4 pt-4 border-bottom mb-2'>
			<div class='col-12'>
				...
				<div
					...
					<div>
					<form action="/party/${party.id}/remove/participant/${guest.id}"
							method="post" class="d-flex justify-content-center">
							<input type="hidden" name="_method" value="put" />
							<button class="btn btn-outline-danger btn-sm mb-2">Remove</button>
						</form>
			...
			<div class='col-12 mt-5'>
				...
				<div
					...
					<div>
						...
						<form action="/party/${party.id}/remove/recipe/${recipe.id}"
							method="post" class="d-flex justify-content-center">
							<input type="hidden" name="_method" value="put" />
							<button class="btn btn-danger btn-sm mb-5">Remove from
								Party</button>
						</form></div>
					</c:forEach>
